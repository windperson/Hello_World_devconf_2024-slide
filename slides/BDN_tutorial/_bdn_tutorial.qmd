...
* Warmup is to warm up the JIT compiler (eq. [RyuJIT](https://devblogs.microsoft.com/dotnet/performance-improvements-in-ryujit-in-net-core-and-net-framework/)).
...
* Simple Loop (***O(n)***)
* Recursion (***O(2^n)***)
* [Golden Ration math formula](https://www.cuemath.com/numbers/fibonacci-series/) (approximation, ***O(1)***)
...
![](./BDN_tutorial/pics/microbenchmark_project_structure.png)
...
![](./BDN_tutorial/pics/not_release_mode_error_on_starting_microbenchmark_project.png)
...
* `--list tree` or `--list flat` : list all benchmark cases.
    ![](./BDN_tutorial/pics/list_microbenchmark_project_tests.png)
* `--help` : show help message.
    ![](./BDN_tutorial/pics/get_microbenchmark_project_help.png)

## Run the microbenchmark {.scrollable}

![](./BDN_tutorial/pics/run_fibSeq_micro-benchmark.png)

## Finish microbenchmark {.scrollable}

![](./BDN_tutorial/pics/done_fibSeq_micro-benchmark.png)
