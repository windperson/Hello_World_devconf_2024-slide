...
* A stress test platform for .NET CLR & AsP.NET Core developer team to do performance test:  
...
* A "Client-Server" architect, which can accept BDN project to build & run for doing micro benchmark:  
