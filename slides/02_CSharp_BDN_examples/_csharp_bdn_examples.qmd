...
And also the example project can use [ETW Profiler of BenchmarkDotNet](https://benchmarkdotnet.org/articles/features/etwprofiler.html) to analyze the performance of WPF view:
